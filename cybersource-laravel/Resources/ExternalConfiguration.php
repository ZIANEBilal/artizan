...
*/
namespace Artizan\Cybersource\Resources;
...
class ExternalConfiguration
{
    ...
    {
        $config = new \Artizan\Cybersource\CybersourceSDK\Authentication\Core\MerchantConfiguration();
    ...
    function ConnectionHost()
    {
        ...
        $config = new \Artizan\Cybersource\CybersourceSDK\Configuration;
