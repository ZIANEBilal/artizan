...
class TransactionDetailsApi
{
     ...
     * @return array of \Artizan\Cybersource\CybersourceSDK\Model\TssV2TransactionsGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getTransactionWithHttpInfo($id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Artizan\Cybersource\CybersourceSDK\Model\TssV2TransactionsGet200Response',
                '/tss/v2/transactions/{id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Artizan\Cybersource\CybersourceSDK\Model\TssV2TransactionsGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Artizan\Cybersource\CybersourceSDK\Model\TssV2TransactionsGet200Response', $e->getResponseHeaders());
