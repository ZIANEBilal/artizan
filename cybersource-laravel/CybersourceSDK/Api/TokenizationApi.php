...
class TokenizationApi
{
     ...
     * Tokenize Card
     *
     * @param \Artizan\Cybersource\CybersourceSDK\Model\TokenizeRequest $tokenizeRequest  (required)
     * @throws \Artizan\Cybersource\CybersourceSDK\ApiException on non-2xx response
     * @return array of \Artizan\Cybersource\CybersourceSDK\Model\FlexV1TokensPost200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function tokenizeWithHttpInfo($tokenizeRequest)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Artizan\Cybersource\CybersourceSDK\Model\FlexV1TokensPost200Response',
                '/flex/v1/tokens'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Artizan\Cybersource\CybersourceSDK\Model\FlexV1TokensPost200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Artizan\Cybersource\CybersourceSDK\Model\FlexV1TokensPost200Response', $e->getResponseHeaders());
