...
class VerificationApi
{
     ...
     *
     * @param \Artizan\Cybersource\CybersourceSDK\Model\ValidateExportComplianceRequest $validateExportComplianceRequest  (required)
     * @throws \Artizan\Cybersource\CybersourceSDK\ApiException on non-2xx response
     * @return array of \Artizan\Cybersource\CybersourceSDK\Model\RiskV1ExportComplianceInquiriesPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function validateExportComplianceWithHttpInfo($validateExportComplianceRequest)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Artizan\Cybersource\CybersourceSDK\Model\RiskV1ExportComplianceInquiriesPost201Response',
                '/risk/v1/export-compliance-inquiries'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Artizan\Cybersource\CybersourceSDK\Model\RiskV1ExportComplianceInquiriesPost201Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Artizan\Cybersource\CybersourceSDK\Model\RiskV1ExportComplianceInquiriesPost201Response', $e->getResponseHeaders());
     ...
     *
     * @param \Artizan\Cybersource\CybersourceSDK\Model\VerifyCustomerAddressRequest $verifyCustomerAddressRequest  (required)
     * @throws \Artizan\Cybersource\CybersourceSDK\ApiException on non-2xx response
     * @return array of \Artizan\Cybersource\CybersourceSDK\Model\RiskV1AddressVerificationsPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function verifyCustomerAddressWithHttpInfo($verifyCustomerAddressRequest)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Artizan\Cybersource\CybersourceSDK\Model\RiskV1AddressVerificationsPost201Response',
                '/risk/v1/address-verifications'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Artizan\Cybersource\CybersourceSDK\Model\RiskV1AddressVerificationsPost201Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Artizan\Cybersource\CybersourceSDK\Model\RiskV1AddressVerificationsPost201Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Artizan\Cybersource\CybersourceSDK\Model\RiskV1DecisionsPost400Response', $e->getResponseHeaders());
