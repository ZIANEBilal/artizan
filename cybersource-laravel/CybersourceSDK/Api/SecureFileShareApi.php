...
class SecureFileShareApi
{
     ...
     * @param string $organizationId Valid Cybersource Organization Id (optional)
     * @throws \Artizan\Cybersource\CybersourceSDK\ApiException on non-2xx response
     * @return array of \Artizan\Cybersource\CybersourceSDK\Model\V1FileDetailsGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getFileDetailWithHttpInfo($startDate, $endDate, $organizationId = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Artizan\Cybersource\CybersourceSDK\Model\V1FileDetailsGet200Response',
                '/sfs/v1/file-details'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Artizan\Cybersource\CybersourceSDK\Model\V1FileDetailsGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Artizan\Cybersource\CybersourceSDK\Model\V1FileDetailsGet200Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Artizan\Cybersource\CybersourceSDK\Model\InlineResponse4001', $e->getResponseHeaders());
