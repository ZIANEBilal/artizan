...
class Ptsv2paymentsOrderInformationBillTo implements ArrayAccess
{
    ...
    /**
     * Sets firstName
     * @param string $firstName Customer’s first name. This name must be the same as the name on the card.  #### Artizan\Cybersource\CybersourceSDK Latin American Processing **Important** For an authorization request, Artizan\Cybersource\CybersourceSDK Latin American Processing concatenates `orderInformation.billTo.firstName` and `orderInformation.billTo.lastName`. If the concatenated value exceeds 30 characters, Artizan\Cybersource\CybersourceSDK Latin American Processing declines the authorization request.\\ **Note** Artizan\Cybersource\CybersourceSDK Latin American Processing is the name of a specific processing connection that Artizan\Cybersource\CybersourceSDK supports. In the Artizan\Cybersource\CybersourceSDK API documentation, Artizan\Cybersource\CybersourceSDK Latin American Processing does not refer to the general topic of processing in Latin America. The information in this field description is for the specific processing connection called _Artizan\Cybersource\CybersourceSDK Latin American Processing_. It is not for any other Latin American processors that Artizan\Cybersource\CybersourceSDK supports.  #### Artizan\Cybersource\CybersourceSDK through VisaNet Credit card networks cannot process transactions that contain non-ASCII characters. Artizan\Cybersource\CybersourceSDK through VisaNet accepts and stores non-ASCII characters correctly and displays them correctly in reports. However, the limitations of the credit card networks prevent Artizan\Cybersource\CybersourceSDK through VisaNet from transmitting non-ASCII characters to the credit card networks. Therefore, Artizan\Cybersource\CybersourceSDK through VisaNet replaces non-ASCII characters with meaningless ASCII characters for transmission to the credit card networks.  #### For Payouts: This field may be sent only for FDC Compass.  **Important** It is your responsibility to determine whether a field is required for the transaction you are requesting.  For processor-specific information, see the `customer_firstname` request-level field description in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html)
     * @return $this
     */
    ...
    /**
     * Sets lastName
     * @param string $lastName Customer’s last name. This name must be the same as the name on the card.  #### Artizan\Cybersource\CybersourceSDK Latin American Processing **Important** For an authorization request, Artizan\Cybersource\CybersourceSDK Latin American Processing concatenates `orderInformation.billTo.firstName` and `orderInformation.billTo.lastName`. If the concatenated value exceeds 30 characters, Artizan\Cybersource\CybersourceSDK Latin American Processing declines the authorization request.\\ **Note** Artizan\Cybersource\CybersourceSDK Latin American Processing is the name of a specific processing connection that Artizan\Cybersource\CybersourceSDK supports. In the Artizan\Cybersource\CybersourceSDK API documentation, Artizan\Cybersource\CybersourceSDK Latin American Processing does not refer to the general topic of processing in Latin America. The information in this field description is for the specific processing connection called Artizan\Cybersource\CybersourceSDK Latin American Processing. It is not for any other Latin American processors that Artizan\Cybersource\CybersourceSDK supports.  #### Artizan\Cybersource\CybersourceSDK through VisaNet Credit card networks cannot process transactions that contain non-ASCII characters. Artizan\Cybersource\CybersourceSDK through VisaNet accepts and stores non-ASCII characters correctly and displays them correctly in reports. However, the limitations of the credit card networks prevent Artizan\Cybersource\CybersourceSDK through VisaNet from transmitting non-ASCII characters to the credit card networks. Therefore, Artizan\Cybersource\CybersourceSDK through VisaNet replaces non-ASCII characters with meaningless ASCII characters for transmission to the credit card networks.  **Important** It is your responsibility to determine whether a field is required for the transaction you are requesting.  #### For Payouts: This field may be sent only for FDC Compass.  For processor-specific information, see the `customer_lastname` request-level field description in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html)
     * @return $this
     */
    ...
    /**
     * Sets address1
     * @param string $address1 Payment card billing street address as it appears on the credit card issuer’s records.  #### Atos This field must not contain colons (:).  #### Artizan\Cybersource\CybersourceSDK through VisaNet **Important** When you populate billing street address 1 and billing street address 2, Artizan\Cybersource\CybersourceSDK through VisaNet concatenates the two values. If the concatenated value exceeds 40 characters, Artizan\Cybersource\CybersourceSDK through VisaNet truncates the value at 40 characters before sending it to Visa and the issuing bank. Truncating this value affects AVS results and therefore might also affect risk decisions and chargebacks. Credit card networks cannot process transactions that contain non-ASCII characters. Artizan\Cybersource\CybersourceSDK through VisaNet accepts and stores non-ASCII characters correctly and displays them correctly in reports. However, the limitations of the credit card networks prevent Artizan\Cybersource\CybersourceSDK through VisaNet from transmitting non-ASCII characters to the credit card networks. Therefore, Artizan\Cybersource\CybersourceSDK through VisaNet replaces non-ASCII characters with meaningless ASCII characters for transmission to the credit card networks.  #### For Payouts: This field may be sent only for FDC Compass.  **Important** It is your responsibility to determine whether a field is required for the transaction you are requesting.  For processor-specific information, see the `bill_address1` request-level field description in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html)
     * @return $this
     */
     ...
     * @param string $administrativeArea State or province of the billing address. Use the State, Province, and Territory Codes for the United States and Canada.  For Payouts: This field may be sent only for FDC Compass.  ##### Artizan\Cybersource\CybersourceSDK through VisaNet Credit card networks cannot process transactions that contain non-ASCII characters. Artizan\Cybersource\CybersourceSDK through VisaNet accepts and stores non-ASCII characters correctly and displays them correctly in reports. However, the limitations of the credit card networks prevent Artizan\Cybersource\CybersourceSDK through VisaNet from transmitting non-ASCII characters to the credit card networks. Therefore, Artizan\Cybersource\CybersourceSDK through VisaNet replaces non-ASCII characters with meaningless ASCII characters for transmission to the credit card networks.  **Important** It is your responsibility to determine whether a field is required for the transaction you are requesting.  For processor-specific information, see the `bill_state` field description in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html)
     * @return $this
     */
    ...
    /**
     * Sets buildingNumber
     * @param string $buildingNumber Building number in the street address.  For example, if the street address is: Rua da Quitanda 187 then the building number is 187.  This field is supported only for:  - Cielo transactions.  - Redecard customer validation with Artizan\Cybersource\CybersourceSDK Latin American Processing.
     * @return $this
     */
    ...
    /**
     * Sets phoneNumber
     * @param string $phoneNumber Customer’s phone number.  #### For Payouts: This field may be sent only for FDC Compass.  Artizan\Cybersource\CybersourceSDK recommends that you include the country code when the order is from outside the U.S.  For processor-specific information, see the customer_phone field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html)  #### Artizan\Cybersource\CybersourceSDK through VisaNet Credit card networks cannot process transactions that contain non-ASCII characters. Artizan\Cybersource\CybersourceSDK through VisaNet accepts and stores non-ASCII characters correctly and displays them correctly in reports. However, the limitations of the credit card networks prevent Artizan\Cybersource\CybersourceSDK through VisaNet from transmitting non-ASCII characters to the credit card networks. Therefore, Artizan\Cybersource\CybersourceSDK through VisaNet replaces non-ASCII characters with meaningless ASCII characters for transmission to the credit card networks.
     * @return $this
     */
