...
class PtsV2PaymentsPost201ResponseOrderInformationInvoiceDetails implements ArrayAccess
{
     ...
     * @param bool $level3TransmissionStatus Indicates whether Artizan\Cybersource\CybersourceSDK sent the Level III information to the processor. The possible values are:  If your account is not enabled for Level III data or if you did not include the purchasing level field in your request, Artizan\Cybersource\CybersourceSDK does not include the Level III data in the request sent to the processor.  For processor-specific information, see the `bill_purchasing_level3_enabled` field description in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html)  Possible values: - **true** - **false**
     * @return $this
     */
