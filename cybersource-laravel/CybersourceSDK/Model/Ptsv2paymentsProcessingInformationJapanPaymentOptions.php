...
class Ptsv2paymentsProcessingInformationJapanPaymentOptions implements ArrayAccess
{
    ...
    /**
     * Sets businessName
     * @param string $businessName Business name in Japanese characters. This field is supported only on JCN Gateway and for the Sumitomo Mitsui Card Co. acquirer on Artizan\Cybersource\CybersourceSDK through VisaNet.
     * @return $this
     */
     ...
     * @param string $businessNameKatakana Business name in Katakana characters. This field is supported only on JCN Gateway and for the Sumitomo Mitsui Card Co. acquirer on Artizan\Cybersource\CybersourceSDK through VisaNet.
     * @return $this
     */
     ...
     * @param string $businessNameAlphaNumeric Business name in alphanumeric characters. This field is supported only on JCN Gateway and for the Sumitomo Mitsui Card Co. acquirer on Artizan\Cybersource\CybersourceSDK through VisaNet.
     * @return $this
     */
