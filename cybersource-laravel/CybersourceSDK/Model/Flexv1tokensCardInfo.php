...
class Flexv1tokensCardInfo implements ArrayAccess
{
    ...
    /**
     * Sets cardNumber
     * @param string $cardNumber Encrypted or plain text card number. If the encryption type of “None” was used in the Generate Key request, this value can be set to the plaintext card number/Personal Account Number (PAN). If the encryption type of RsaOaep256 was used in the Generate Key request, this value needs to be the RSA OAEP 256 encrypted card number. The card number should be encrypted on the cardholders’ device. The [WebCrypto API] (https://github.com/Artizan\Cybersource\CybersourceSDK/cybersource-flex-samples/blob/master/java/spring-boot/src/main/resources/public/flex.js) can be used with the JWK obtained in the Generate Key request.
     * @return $this
     */
    ...
    /**
     * Sets cardType
     * @param string $cardType Card Type. This field is required. Refer to the Artizan\Cybersource\CybersourceSDK Credit Card Services documentation for supported card types.
     * @return $this
     */
