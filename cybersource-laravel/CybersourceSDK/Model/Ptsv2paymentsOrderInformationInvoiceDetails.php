...
class Ptsv2paymentsOrderInformationInvoiceDetails implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'merchandiseCode' => 'int',
        'transactionAdviceAddendum' => '\Artizan\Cybersource\CybersourceSDK\Model\Ptsv2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum[]',
     ...
     * @param string $purchaseOrderNumber Value used by your customer to identify the order. This value is typically a purchase order number. Artizan\Cybersource\CybersourceSDK recommends that you do not populate the field with all zeros or nines.  For processor-specific information, see the `user_po` field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html)
     * @return $this
     */
    ...
    /**
     * Sets taxable
     * @param bool $taxable Flag that indicates whether an order is taxable. This value must be true if the sum of all _lineItems[].taxAmount_ values > 0.  If you do not include any `lineItems[].taxAmount` values in your request, Artizan\Cybersource\CybersourceSDK does not include `invoiceDetails.taxable` in the data it sends to the processor.  For processor-specific information, see the `tax_indicator` field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html)  Possible values:  - **true**  - **false**
     * @return $this
     */
     ...
     * @return \Artizan\Cybersource\CybersourceSDK\Model\Ptsv2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum[]
     */
     ...
     * @param \Artizan\Cybersource\CybersourceSDK\Model\Ptsv2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum[] $transactionAdviceAddendum
     * @return $this
     */
     ...
     * @param string $referenceDataNumber Reference number. The meaning of this value is identified by the value of the `referenceDataCode` field.  This field is a pass-through, which means that Artizan\Cybersource\CybersourceSDK does not verify the value or modify it in any way before sending it to the processor.
     * @return $this
     */
     ...
     * @param int $salesSlipNumber Transaction identifier that Artizan\Cybersource\CybersourceSDK generates. You have the option of printing the sales slip number on the receipt. This field is supported only on Cybersource through Visanet and JCN gateway.
     * @return $this
     */
