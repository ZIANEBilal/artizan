...
class PtsV2PaymentsPost201ResponseProcessorInformation implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'avs' => '\Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationAvs',
        'cardVerification' => '\Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationCardVerification',
        'merchantAdvice' => '\Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice',
        'electronicVerificationResults' => '\Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationElectronicVerificationResults',
        'achVerification' => '\Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationAchVerification',
        'customer' => '\Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationCustomer',
        'consumerAuthenticationResponse' => '\Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationConsumerAuthenticationResponse',
        ...
        'name' => 'string',
        'routing' => '\Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationRouting',
     ...
     * @param string $forwardedAcquirerCode Name of the Japanese acquirer that processed the transaction. Returned only for JCN Gateway. Please contact the Artizan\Cybersource\CybersourceSDK Japan Support Group for more information.
     * @return $this
     */
    ...
    /**
     * Gets avs
     * @return \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationAvs
     */
    ...
    /**
     * Sets avs
     * @param \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationAvs $avs
     * @return $this
     */
     ...
     * @return \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationCardVerification
     */
     ...
     * @param \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationCardVerification $cardVerification
     * @return $this
     */
     ...
     * @return \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationElectronicVerificationResults
     */
     ...
     * @param \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationElectronicVerificationResults $electronicVerificationResults
     * @return $this
     */
     ...
     * @return \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationAchVerification
     */
     ...
     * @param \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationAchVerification $achVerification
     * @return $this
     */
    ...
    /**
     * Gets customer
     * @return \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationCustomer
     */
    ...
    /**
     * Sets customer
     * @param \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationCustomer $customer
     * @return $this
     */
     ...
     * @return \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationConsumerAuthenticationResponse
     */
     ...
     * @param \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationConsumerAuthenticationResponse $consumerAuthenticationResponse
     * @return $this
     */
     ...
     * @param string $masterCardServiceCode Mastercard service that was used for the transaction. Mastercard provides this value to Artizan\Cybersource\CybersourceSDK.  Possible value:  - 53: Mastercard card-on-file token service  #### Artizan\Cybersource\CybersourceSDK through VisaNet The value for this field corresponds to the following data in the TC 33 capture file: - Record: CP01 TCR6 - Position: 133-134 - Field: Mastercard Merchant on-behalf service. **Note** This field is returned only for Artizan\Cybersource\CybersourceSDK through VisaNet.
     * @return $this
     */
     ...
     * @param string $masterCardServiceReplyCode Result of the Mastercard card-on-file token service. Mastercard provides this value to Artizan\Cybersource\CybersourceSDK.  Possible values:   - `C`: Service completed successfully.  - `F`: One of the following:    - Incorrect Mastercard POS entry mode. The Mastercard POS entry mode should be 81 for an authorization or      authorization reversal.    - Incorrect Mastercard POS entry mode. The Mastercard POS entry mode should be 01 for a tokenized request.    - Token requestor ID is missing or formatted incorrectly.  - `I`: One of the following:    - Invalid token requestor ID.    - Suspended or deactivated token.    - Invalid token (not in mapping table).  - `T`: Invalid combination of token requestor ID and token.  - `U`: Expired token.  - `W`: Primary account number (PAN) listed in electronic warning bulletin.  **Note** This field is returned only for **Artizan\Cybersource\CybersourceSDK through VisaNet**.
     * @return $this
     */
     ...
     * @param string $masterCardAuthenticationType Type of authentication for which the transaction qualifies as determined by the Mastercard authentication service, which confirms the identity of the cardholder. Mastercard provides this value to Artizan\Cybersource\CybersourceSDK.  Possible values:   - `1`: Transaction qualifies for Mastercard authentication type 1.  - `2`: Transaction qualifies for Mastercard authentication type 2.  #### Artizan\Cybersource\CybersourceSDK through VisaNet The value for this field corresponds to the following data in the TC 33 capture file: - Record: CP01 TCR6 - Position: 132 - Field: Mastercard Member Defined service. **Note** This field is returned only for Artizan\Cybersource\CybersourceSDK through VisaNet.
     * @return $this
     */
    ...
    /**
     * Gets routing
     * @return \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationRouting
     */
    ...
    /**
     * Sets routing
     * @param \Artizan\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationRouting $routing
     * @return $this
     */
