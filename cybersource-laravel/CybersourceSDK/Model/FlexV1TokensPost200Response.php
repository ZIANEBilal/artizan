...
class FlexV1TokensPost200Response implements ArrayAccess
{
    ...
    /**
     * Sets token
     * @param string $token The generated token. The token replaces card data and is used as the Subscription ID in the Artizan\Cybersource\CybersourceSDK Simple Order API or SCMP API.
     * @return $this
     */
