...
class TssV2TransactionsGet200ResponseClientReferenceInformation implements ArrayAccess
{
     ...
     * @param string $applicationVersion Version of the Artizan\Cybersource\CybersourceSDK application or integration used for a transaction.
     * @return $this
     */
     ...
     * @param string $applicationName The name of the Connection Method client (such as Virtual Terminal or SOAP Toolkit API) that the merchant uses to send a transaction request to Artizan\Cybersource\CybersourceSDK.
     * @return $this
     */
     ...
     * @param string $applicationUser The entity that is responsible for running the transaction and submitting the processing request to Artizan\Cybersource\CybersourceSDK. This could be a person, a system, or a connection method.
     * @return $this
     */
