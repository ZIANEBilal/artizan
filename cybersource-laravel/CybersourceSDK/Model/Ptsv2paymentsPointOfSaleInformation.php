...
class Ptsv2paymentsPointOfSaleInformation implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'emv' => '\Artizan\Cybersource\CybersourceSDK\Model\Ptsv2paymentsPointOfSaleInformationEmv',
        'amexCapnData' => 'string',
        'trackData' => 'string',
    ...
    /**
     * Sets terminalId
     * @param string $terminalId Identifier for the terminal at your retail location. You can define this value yourself, but consult the processor for requirements.  #### FDC Nashville Global To have your account configured to support this field, contact Artizan\Cybersource\CybersourceSDK Customer Support. This value must be a value that FDC Nashville Global issued to you.  For details, see the `terminal_id` field description in [Card-Present Processing Using the SCMP API.](https://apps.cybersource.com/library/documentation/dev_guides/Retail_SCMP_API/html/)  **For Payouts**: This field is applicable for CtV.
     * @return $this
     */
     ...
     * @param string $terminalSerialNumber Terminal serial number assigned by the hardware manufacturer. This value is provided by the client software that is installed on the POS terminal.  Artizan\Cybersource\CybersourceSDK does not forward this value to the processor. Instead, the value is forwarded to the Artizan\Cybersource\CybersourceSDK reporting functionality.  This field is supported only on American Express Direct, FDC Nashville Global, and SIX.  For details, see the `terminal_serial_number` field description in [Card-Present Processing Using the SCMP API.](https://apps.cybersource.com/library/documentation/dev_guides/Retail_SCMP_API/html/)
     * @return $this
     */
    ...
    /**
     * Gets emv
     * @return \Artizan\Cybersource\CybersourceSDK\Model\Ptsv2paymentsPointOfSaleInformationEmv
     */
    ...
    /**
     * Sets emv
     * @param \Artizan\Cybersource\CybersourceSDK\Model\Ptsv2paymentsPointOfSaleInformationEmv $emv
     * @return $this
     */
    ...
    /**
     * Sets amexCapnData
     * @param string $amexCapnData Point-of-sale details for the transaction. This value is returned only for **American Express Direct**. Artizan\Cybersource\CybersourceSDK generates this value, which consists of a series of codes that identify terminal capability, security data, and specific conditions present at the time the transaction occurred. To comply with the CAPN requirements, this value must be included in all subsequent follow-on requests, such as captures and follow-on credits.  When you perform authorizations, captures, and credits through Artizan\Cybersource\CybersourceSDK, Artizan\Cybersource\CybersourceSDK passes this value from the authorization service to the subsequent services for you. However, when you perform authorizations through Artizan\Cybersource\CybersourceSDK and perform subsequent services through other financial institutions, you must ensure that your requests for captures and credits include this value.  For details, see `auth_pos_data` field description in [Credit Card Services Using the SCMP API.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/)
     * @return $this
     */
     ...
     * @param string $storeAndForwardIndicator When connectivity is unavailable, the client software that is installed on the POS terminal can store a transaction in its memory and send it for authorization when connectivity is restored. This value is provided by the client software that is installed on the POS terminal.  Artizan\Cybersource\CybersourceSDK does not forward this value to the processor. Instead, the value is forwarded to the Artizan\Cybersource\CybersourceSDK reporting functionality.  Possible values: - Y: Transaction was stored and then forwarded. - N (default): Transaction was not stored and then forwarded.  This field is supported only on American Express Direct, FDC Nashville Global, and SIX.
     * @return $this
     */
    ...
    /**
     * Sets deviceId
     * @param string $deviceId Value created by the client software that uniquely identifies the POS device. This value is provided by the client software that is installed on the POS terminal.  Artizan\Cybersource\CybersourceSDK does not forward this value to the processor. Instead, the value is forwarded to the Artizan\Cybersource\CybersourceSDK reporting functionality.  This field is supported only on American Express Direct, FDC Nashville Global, and SIX.
     * @return $this
     */
     ...
     * @param string $partnerSdkVersion Version of the software installed on the POS terminal. This value is provided by the client software that is installed on the POS terminal.  Artizan\Cybersource\CybersourceSDK does not forward this value to the processor. Instead, the value is forwarded to the Artizan\Cybersource\CybersourceSDK reporting functionality.  This field is supported only on American Express Direct, FDC Nashville Global, and SIX.
     * @return $this
     */
