...
class PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures implements ArrayAccess
{
    ...
    /**
     * Sets accountStatus
     * @param string $accountStatus Possible values:   - `N`: Nonregulated  - `R`: Regulated  **Note** This field is returned only for Artizan\Cybersource\CybersourceSDK through VisaNet.
     * @return $this
     */
    ...
    /**
     * Sets group
     * @param string $group Type of commercial card. This field is supported only for Artizan\Cybersource\CybersourceSDK through VisaNet. Possible values:   - **B**: Business card  - **R**: Corporate card  - **S**: Purchasing card  - **0**: Noncommercial card
     * @return $this
     */
