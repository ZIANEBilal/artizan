...
class Ptsv2paymentsMerchantInformationServiceFeeDescriptor implements ArrayAccess
{
    ...
    /**
     * Sets contact
     * @param string $contact Contact information for the service provider that is collecting the service fee. when you include more than one consecutive space, extra spaces are removed.  When you do not include this value in your request, Artizan\Cybersource\CybersourceSDK uses the value that is in your Artizan\Cybersource\CybersourceSDK account.  This value might be displayed on the cardholder’s statement.
     * @return $this
     */
    ...
    /**
     * Sets state
     * @param string $state State or territory in which the service provider is located.  When you do not include this value in your request, Artizan\Cybersource\CybersourceSDK uses the value that is in your Artizan\Cybersource\CybersourceSDK account.  This value might be displayed on the cardholder’s statement.
     * @return $this
     */
