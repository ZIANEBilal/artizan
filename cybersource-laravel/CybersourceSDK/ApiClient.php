...
namespace Artizan\Cybersource\CybersourceSDK;
use Artizan\Cybersource\CybersourceSDK\Authentication\Core\Authentication as Authentication;
...
class ApiClient
{
     ...
     */
    public function __construct(\Artizan\Cybersource\CybersourceSDK\Configuration $config = null, \Artizan\Cybersource\CybersourceSDK\Authentication\Core\MerchantConfiguration $merchantConfig = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \Artizan\Cybersource\CybersourceSDK\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\Artizan\Cybersource\CybersourceSDK\ObjectSerializer::sanitizeForSerialization($postData));
        }
